    ...
    <div className="container mx-auto px-4 lg:w-3/4 my-24">
      {data.expired && (
        <div>
          ...
          <p className="text-center mt-12 mb-2 text-lg">To reward you for trying out <span className="text-gradient font-bold">paste.jpc.io</span>, here&apos;s a game of cards!</p>
          <CardGame />
        </div>
      )}
      {!data.expired && (
